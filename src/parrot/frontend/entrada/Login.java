...
import parrot.backend.manejadores.ManejadorLogin;
...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setForeground(new java.awt.Color(1, 3, 107));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
        ManejadorLogin.getInstance().login(jTextField1.getText(), jPasswordField1.getPassword(), this);            
        } catch (Exception e) {
